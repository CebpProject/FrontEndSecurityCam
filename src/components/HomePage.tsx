        ...
        <div className="bg-background-alt min-h-screen flex flex-col justify-center">
            ...
            <main className="container mx-auto p-4 bg-background-alt flex-grow">
                <div className="relative text-center mb-8">
                    <h1 className="text-4xl min-h-40 font-bold justify-center text-center bg-cover bg-no-repeat text-white p-8 rounded-md flex items-center" style={{ backgroundImage: 'url("/sec3.png")', backgroundSize: '100% auto', backgroundPosition: 'center' }}>
                        Welcome to Security Cam
                    </h1>
                </div>
                <div className="text-center relative mb-2">
                    <div className="mb-8 mr-8 mt-8">
                        <Link href="/register" className='button relative bg-accent-dark mb-8 rounded-md outline-none shadow-[0_3px_0px_0px_rgba(255,255,255)] font-extrabold hover:bg-accent hover:shadow-[0_2px_0px_0px_rgba(255,255,255)] hover:translate-y-[2px] active:shadow-none active:translate-y-[4px] transition duration-[100] ease-in-out text-center justify-center p-3 pl-12 pr-12 m-4'
                    ...
                    <div className="mb-8 mt-8 mr-8">
                        <Link href="/feed" className='button relative bg-accent-dark mb-8 rounded-md outline-none shadow-[0_3px_0px_0px_rgba(255,255,255)] font-extrabold hover:bg-accent hover:shadow-[0_2px_0px_0px_rgba(255,255,255)] hover:translate-y-[2px] active:shadow-none active:translate-y-[4px] transition duration-[100] ease-in-out text-center justify-center p-3 pl-12 pr-12 m-4'
